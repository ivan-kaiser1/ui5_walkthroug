		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5walkthroug-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5walkthroug-display": {
								"semanticObject": "ui5walkthroug",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5walkthroug",
									"url": sap.ui.require.toUrl("ui5walkthroug")
								}
							}
						}
					}
